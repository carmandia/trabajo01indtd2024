...
```
Si observamos la salida q nos proporciona esta funcion, todos los criterios excepto el de wald, que nos dice que la mejor opcion es elegir el primer caso, el resto de criterios nos dice q la mejor opcion es tomar la decision 4
